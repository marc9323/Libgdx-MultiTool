...
public class SpriteBatchSampleCookbook extends SampleBase implements ApplicationListener {

    private static final Logger log =
            new Logger(SpriteBatchSampleCookbook.class.getName(),
                    Logger.DEBUG);

    public static final SampleInfo SAMPLE_INFO = new SampleInfo(SpriteBatchSampleCookbook.class);

    private static final Color BACKGROUND_COLOR =
            new Color(0.39f, 0.58f, 0.92f, 1.0f);
    ...
    public void create() {
        ...
        cavemanTexture = new Texture(Gdx.files.internal("art/caveman.png"));
